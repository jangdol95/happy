...
// 	alert(id+":"+pw);
	...
	var frm=document.forms[0];//document.geetElementById("frm");
	frm.action="./login.do";
	var result="";
...
<div id="container">
	...
	<form method="post" id="frm">
		...
		<input type="text" name="id" id="inputId" required="required" placeholder="숫자/대소문자영문">
		
		<div id="pw">비밀번호</div>
		<input type="password" name="pw" id="inputPw" required="required" placeholder="비밀번호입력">
		<br>
		...
		<div id="bottom">
			...
			<input id="SearchId" type="button" value="아이디 찾기" onclick="idSearch()">
			<input id="SearchPw" type="button" value="비밀번호 찾기" onclick="pwSearch()">
